...
const AnimePage = () => {
  ...
  const postNewRecipe = async () => {
    const endpoint = Config.apiUri + "/recipes";

    const recipe =
    {
      name: newName,
      "author": localStorage.getItem("anime-hub-username"),
      "anime": anime?.title,
      "animeid": animeId,
    ...
    const authString = btoa(`${localStorage.getItem("anime-hub-username")}:${localStorage.getItem("anime-hub-password")}`);
    ...
    try {
      ...
      if (!res.ok) {
          throw new Error('cannot publish recipe');
      } else {
        fetchRecipes();
        setName("");
        setIngredients("");
    ...
    <div>
      ...
      <span><h1>Recettes</h1></span>
        ...
        })}
        {
          ...
          <div className="new-recipe">
            <input className="new-recipe__input" type="text" placeholder="Nom" onChange={ changeName } value={ newName }></input>
            <textarea className="new-recipe__text" rows="5" cols="33" placeholder="Ingrédients" onChange={ changeIngredients } value={ newIngredients }></textarea>
            <textarea className="new-recipe__text" rows="5" cols="33" placeholder="Préparation" onChange={ changePrep } value={ newPrep }></textarea>
            <button onClick={ postNewRecipe }>Publier</button>
          </div>
          :
          ''
        }
      ...
      <span><h1>Studio</h1></span>
        ...
        <div className="studio-container">
          ...
          <iframe title="map" src={ "https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d74508.01159511728!2d" + studio?.lon + "!3d" + studio?.lat + "!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sfr!2sfr!4v1718806540268!5m2!1sfr!2sfr" } loading="lazy"></iframe>
        </div>
      </div>
      <Outlet />
    </div>
